...
namespace DiplomaTests.Pages.LeavePage
{
    public class LeavePage : PageBase
    {
        ...
        public void GoToAssignLeave() => AssignLeaveNav.Click();
        ...
        public void AssignLeave() => SaveButton.Click();
        
        public void ConfirmLeaveAssignment() => ConfirmLeaveButton.Click();

        public void WaitForsuccessfulAlert() => new WebElementWrapper().IsElementDisplayed(AlertOnCreatingLeave);
    }
}
